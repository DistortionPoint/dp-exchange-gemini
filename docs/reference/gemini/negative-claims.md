...
| No `preview_order/3`, no `replace_order/4` | inventory | **holds.** Neither appears in the specifications. Amending is cancel-then-place, which opens a window in which no order is live — stated rather than hidden |
