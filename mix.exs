defmodule DpExchangeGemini.MixProject do
  use Mix.Project
  ...
  def project do
    [
      ...
      # Hex.pm
      name: "DpExchangeGemini",
      description:
        "EXPERIMENTAL — Gemini venue package for the DpExchange family. Market data, " <>
  ...
  # consumer that has not asked for Gemini must not find a socket open.
  def application do
